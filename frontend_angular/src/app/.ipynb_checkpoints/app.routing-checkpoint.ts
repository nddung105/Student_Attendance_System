...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      //   loadChildren: () => import('./views/plate-detection/plate-detection.module').then(m => m.PlateDetectionModule)
      // },
      {
        path: 'stream-recognition',
        pathMatch: 'prefix',
        canLoad: [AuthenticationGuard],
        loadChildren: () => import('./views/stream-recognition/stream-recognition.module').then(m => m.StreamRecognitionModule)
      },
      {
        path: 'realtime',
        pathMatch: 'prefix',
