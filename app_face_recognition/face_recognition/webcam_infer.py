...
from face_recognition.mtcnn.extract_face import cut_face
import cv2
...
parser.add_argument(
    ...
    default='face_recognition/frozen_facenet/20180408-102900/20180408-102900.pb')
parser.add_argument('--svc_model',
                    type=str,
                    help='Path of SVC model classification',
                    default='face_recognition/weights/classifier.pkl')
parser.add_argument('--mtcnn_model',
                    type=str,
                    help='Directory with weights MTCNN',
                    default='face_recognition/weights/mtcnn_weights.npy')
...
def facenet_embed(frozen_model,
                face,
                image_size=160,
                seed=666):
    with tf.Graph().as_default():
